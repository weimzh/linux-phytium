...
int phytium_dp_hw_init(struct phytium_dp_device *phytium_dp)
{
	...
	phytium_writel_reg(priv, AUX_CLK_DIVIDER, group_offset, PHYTIUM_DP_AUX_CLK_DIVIDER);
...
static void phytium_dp_hw_set_source_rate_and_lane_count(struct phytium_dp_device *phytium_dp)
{
...
int phytium_dp_init(struct drm_device *dev, int port)
{
	...
	phytium_dp_hw_set_source_rate_and_lane_count(phytium_dp);
